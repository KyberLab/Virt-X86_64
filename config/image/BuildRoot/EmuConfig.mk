...
# qemu-system-x86_64 -M virt -cpu kvm64 -nographic -smp 1 -kernel Image -append "rootwait root=/dev/vda console=ttyS0" -netdev user,id=eth0 -device virtio-net-device,netdev=eth0 -drive file=rootfs.ext4,if=none,format=raw,id=hd0 -device virtio-blk-device,drive=hd0
